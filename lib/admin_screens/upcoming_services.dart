...
class UpcomingServiceScreen extends StatefulWidget {
  const UpcomingServiceScreen({Key? key}) : super(key: key);

  @override
  State<UpcomingServiceScreen> createState() => _UpcomingServiceScreenState();
}
      ...
      ch: SafeArea(
        child: SingleChildScrollView(
          child: FutureBuilder<OrderDetailModel>(
            future: AdminAuthProvider.getVendorUpcomingServices(),
